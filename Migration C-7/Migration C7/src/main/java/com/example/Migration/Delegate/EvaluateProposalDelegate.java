...
public class EvaluateProposalDelegate implements JavaDelegate {
    ...
    public void execute(DelegateExecution ex) {
        try {
            Object originalProductIdObj = ex.getVariable("selectedProductId");
            Object chosenAlternativeIdObj = ex.getVariable("chosenAlternativeId");
            ...
            if (originalProductId == null) {
                ...
                ex.setVariable("approved", false);
                ex.setVariable("errorMessage", "Original product ID is required");
                return;
            }
            ...
            if (originalPriceOpt.isEmpty()) {
                ...
                ex.setVariable("approved", false);
                ex.setVariable("errorMessage", "Original product not found");
                return;
            }
            ...
            if (chosenAlternativeId != null) {
                ...
                if (newPriceOpt.isEmpty()) {
                    ...
                    ex.setVariable("approved", false);
                    ex.setVariable("errorMessage", "Alternative product not found");
                    return;
                }
            ...
            ex.setVariable("amountDue", amountDue);
            ex.setVariable("approved", approved);
            ex.setVariable("originalPrice", oldPrice);
            ex.setVariable("newPrice", newPrice);
            ex.setVariable("priceDifference", priceDifference);
            ex.setVariable("finalProductId", finalProductId);
            ex.setVariable("errorMessage", null);
            ...
            ex.setVariable("approved", false);
            ex.setVariable("errorMessage", "Error evaluating proposal: " + e.getMessage());
        }
    }
